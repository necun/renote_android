...
class ViewFinderOverlay(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    private val boxPaint: Paint = Paint().apply {
        ...
        strokeWidth = context.resources.getDimensionPixelOffset(R.dimen.dp4).toFloat()
    }

    private val scrimPaint: Paint = Paint().apply {
        color = ContextCompat.getColor(context, R.color.colorTransperatGray)
    }
    ...
    private val boxCornerRadius: Float =
        context.resources.getDimensionPixelOffset(R.dimen.dp_8).toFloat()
