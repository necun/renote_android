...
void JNICALL
Java_com_renote_renoteai_ui_activities_camera_libs_CVLib_getReducedImage(JNIEnv *env,
                                                         jobject instance,
                                                         jlong matAddr,
                                                         jlong resultAddr) {
...
void JNICALL
Java_com_renote_renoteai_ui_activities_camera_libs_CVLib_getDocumentMask(JNIEnv *env,
                                                         jobject instance,
                                                         jlong matAddr,
                                                         jlong maskAddr) {
...
jboolean JNICALL
Java_com_renote_renoteai_ui_activities_camera_libs_CVLib_getDocumentContour(JNIEnv *env,
                                                            jobject instance,
                                                            jlong maskAddr,
                                                            jlong cntAddr) {
...
jboolean JNICALL
Java_com_renote_renoteai_ui_activities_camera_libs_CVLib_getDocumentApproxContour(JNIEnv *env,
                                                                  jobject instance,
                                                                  jlong cntAddr,
                                                                  jlong cntApproxAddr
) {
...
void JNICALL
Java_com_renote_renoteai_ui_activities_camera_libs_CVLib_resizeContour(JNIEnv *env,
                                                       jobject instance,
                                                       jlong matAddr,
...
void JNICALL
Java_com_renote_renoteai_ui_activities_camera_libs_CVLib_drawContour(JNIEnv *env,
                                                     jobject instance,
                                                     jlong matAddr,
                                                     jlong cntAddr,
...
void JNICALL
Java_com_renote_renoteai_ui_activities_camera_libs_CVLib_getRotatedImage(JNIEnv *env,
                                                         jobject instance,
                                                         jlong matAddr,
                                                         jlong resultAddr) {
...
jboolean JNICALL
Java_com_renote_renoteai_ui_activities_camera_libs_CVLib_isContourValid(JNIEnv *env,
                                                        jobject instance,
                                                        jlong cntAddr,
                                                        jlong pcntAddr) {
...
void JNICALL
Java_com_renote_renoteai_ui_activities_camera_libs_CVLib_smoothenContour(JNIEnv *env,
                                                         jobject instance,
                                                         jlong cntAddr,
                                                         jlong pcntAddr,
                                                         jlong acntAddr) {
...
void JNICALL
Java_com_renote_renoteai_ui_activities_camera_libs_CVLib_drawContourDots(JNIEnv *env,
                                                         jobject instance,
                                                         jlong matAddr,
                                                         jlong cntAddr,
                                                         jint r, jint g, jint b
...
void JNICALL
Java_com_renote_renoteai_ui_activities_camera_libs_CVLib_doFilterEnhance(JNIEnv *env,
                                                         jobject instance,
                                                         jlong matAddr,
                                                         jlong resultAddr) {
    ...
    alpha.forEach<float>
            (
                    [&](auto &pixel, const int *position) -> void {
                        float a = (pixel / 255.f);
                        a = std::min(a * 2.f, 1.f);
                        Vec3f blended = a * (Vec3f) img_soft.at<Vec3b>(position) +
                                        (1.f - a) * (Vec3f) whiten.at<Vec3b>(position);
                        Vec3b blended_u8;
...
void JNICALL
Java_com_renote_renoteai_ui_activities_camera_libs_CVLib_doFilterGrayscale(JNIEnv *env,
                                                           jobject instance,
                                                           jlong matAddr,
                                                           jlong resultAddr) {
    // get Mat from raw address
...
void JNICALL
Java_com_renote_renoteai_ui_activities_camera_libs_CVLib_doFilterBW(JNIEnv *env,
                                                    jobject instance,
                                                    jlong matAddr,
                                                    jlong resultAddr) {
    // get Mat from raw address
...
void JNICALL
Java_com_renote_renoteai_ui_activities_camera_libs_CVLib_getDocumentWarped(
        JNIEnv *env,
        jobject instance,
        jlong matAddr,
        jlong resultAddr,
...
void JNICALL
Java_com_renote_renoteai_ui_activities_camera_libs_CVLib_doFilterSoft(JNIEnv *env,
                                                      jobject instance,
                                                      jlong matAddr,
                                                      jlong resultAddr) {
...
void JNICALL
Java_com_renote_renoteai_ui_activities_camera_libs_CVLib_doFilterClear(JNIEnv *env,
                                                       jobject instance,
                                                       jlong matAddr,
                                                       jlong resultAddr) {
        ...
        for (int y = y0; y < y0 + h; ++y) {
            for (int x = x0; x < x0 + w; ++x) {
                if (labels.at<int>(y, x) == i) {
                    ...
                    for (int j = 0; j < K; ++j) {
                        result[0] += (dist.at<float>(counter, j) / sum_i) *
                                     kmeans_centers.at<float>(j, 0);
                        result[1] += (dist.at<float>(counter, j) / sum_i) *
                                     kmeans_centers.at<float>(j, 1);
                        result[2] += (dist.at<float>(counter, j) / sum_i) *
                                     kmeans_centers.at<float>(j, 2);
                    }
...
void JNICALL
Java_com_renote_renoteai_ui_activities_camera_libs_CVLib_addContour(JNIEnv *env,
                                                    jobject instance,
                                                    jlong cntAddr,
                                                    jlong acntAddr) {
...
void JNICALL
Java_com_renote_renoteai_ui_activities_camera_libs_CVLib_divContour(JNIEnv *env,
                                                    jobject instance,
                                                    jlong acntAddr,
                                                    jlong bcntAddr,
                                                    jint count) {
...
void JNICALL
Java_com_renote_renoteai_ui_activities_camera_libs_CVLib_drawContourLines(JNIEnv *env,
                                                          jobject instance,
                                                          jlong matAddr,
                                                          jlong cntAddr,
                                                          jint r, jint g, jint b
...
void JNICALL
Java_com_renote_renoteai_ui_activities_camera_libs_CVLib_splitBook(JNIEnv *env,
                                                   jobject instance,
                                                   jlong matAddr,
                                                   jlong page1Addr,
                                                   jlong page2Addr) {
...
void JNICALL
Java_com_renote_renoteai_ui_activities_camera_libs_CVLib_createWhiteBackground(JNIEnv *env,
                                                               jobject instance,
                                                               jlong matAddr,
...
void JNICALL
Java_com_renote_renoteai_ui_activities_camera_libs_CVLib_blitImage(JNIEnv *env,
                                                   jobject instance,
                                                   jlong matAddr,
                                                   jlong srcAddr,
